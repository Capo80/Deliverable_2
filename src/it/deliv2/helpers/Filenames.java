...
public final class Filenames {
	...
	public static final String METRICS_FILE = PROJ_NAME+"metrics.csv";
	public static final String FINAL_FILE = PROJ_NAME+"final.csv";
	public static final String CLASSIFIER_FILE = PROJ_NAME+"classifiersInfo.csv";
